...
examples: [Palette addressing](/docs/api/palette#palette-addressing). Draw semantics: [API: Rendering](/docs/api/rendering).
...
See [Bitmap Fonts Guide](https://github.com/blit386/blit386/blob/main/docs/bitmap-fonts.md) for the `.btfont` format specification and the BMFont conversion workflow
...
[Palette Presets — HUD](https://github.com/blit386/blit386/blob/main/docs/palette-presets.md#hud-preset-paletteapplyhud). The engine draws its own overlay (present FPS,
target FPS, draw calls, frame/update()/render() timings, backend, resolution, demo title) after each `render()` when
`isOverlayEnabled` is true; see [Overlay Guide](https://github.com/blit386/blit386/blob/main/docs/overlay.md). For styled variable-width text, use a bitmap font instead.
...
| ------------------------------------- | --------------------------------------- |
| [API: Core](/docs/api/core)              | bootstrap, init, game loop, core types  |
| [API: Rendering](/docs/api/rendering)    | primitives, sprites, text, post-process |
| [API: Palette](/docs/api/palette)        | palette setup, presets, effects         |
| [Palette Guide](https://github.com/blit386/blit386/blob/main/docs/palette-guide.md)     | palette-first setup, offsets, refresh   |
| [Palette Presets](https://github.com/blit386/blit386/blob/main/docs/palette-presets.md) | built-in preset reference               |
| [Bitmap Fonts](https://github.com/blit386/blit386/blob/main/docs/bitmap-fonts.md)       | .btfont format, BMFont conversion       |
| [Overlay Guide](https://github.com/blit386/blit386/blob/main/docs/overlay.md)           | system font for HUD text                |
| [Testing](https://github.com/blit386/blit386/blob/main/docs/testing.md)                 | SpriteSheet and BitmapFont tests        |
