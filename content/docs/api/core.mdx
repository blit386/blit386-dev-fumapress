...
lastModified: "2026-07-07T08:17:09+02:00"
...
[Core Types](/docs/api/core-types) (`Vector2i`, `Rect2i`, `Color32`), [Audio](/docs/api/audio) (bus volume, mute, unlock
state), and [Browser Support](/docs/api/browser-support).
