...
See [Post-Process Effects](https://github.com/blit386/blit386/blob/main/docs/post-process-effects.md) for tier routing and presets.
...
| [API: Palette](https://github.com/blit386/blit386/blob/main/docs/api-palette.md)                  | palette setup, presets, effects                        |
| [Palette Guide](https://github.com/blit386/blit386/blob/main/docs/palette-guide.md)               | palette-first workflow and practical patterns          |
...
| [Testing](https://github.com/blit386/blit386/blob/main/docs/testing.md)                           | test tiers, WebGPU mocks                               |
| [Overlay Guide](https://github.com/blit386/blit386/blob/main/docs/overlay.md)                     | engine HUD subsystem, toggle, layout                   |
| [Post-Process Effects](https://github.com/blit386/blit386/blob/main/docs/post-process-effects.md) | effect chain and tiers                                 |
| [Deprecation Timeline](/docs/reference/deprecations)         | renamed configure flags and getters                    |
