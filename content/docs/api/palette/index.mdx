...
[Palette Guide](https://github.com/blit386/blit386/blob/main/docs/palette-guide.md) section 6.
...
| [Palette Guide](https://github.com/blit386/blit386/blob/main/docs/palette-guide.md)               | end-to-end workflow; links to Palette addressing |
| [Palette Presets](https://github.com/blit386/blit386/blob/main/docs/palette-presets.md)           | exact built-in palette and HUD color data        |
| [Testing](https://github.com/blit386/blit386/blob/main/docs/testing.md)                           | test tiers and palette testing patterns          |
| [Post-Process Effects](https://github.com/blit386/blit386/blob/main/docs/post-process-effects.md) | pixel-tier effects on palette indices            |
| [Overlay Guide](https://github.com/blit386/blit386/blob/main/docs/overlay.md)                     | `applyHUD` and HUD slot colors                   |
