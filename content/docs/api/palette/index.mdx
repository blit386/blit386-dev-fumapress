...
| [Palette Guide](/docs/guides/palette)               | end-to-end workflow; links to Palette addressing |
| [Palette Presets](/docs/guides/palette-presets)           | exact built-in palette and HUD color data        |
...
| [Overlay Guide](/docs/guides/overlay)                     | `applyHUD` and HUD slot colors                   |
