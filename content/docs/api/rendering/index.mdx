...
See [Post-Process Effects Guide](/docs/guides/post-process-effects) for parameter reference, the `Effect` interface, `EffectTier`,
...
| [Palette Guide](/docs/guides/palette)                           | palette-first workflow and offset patterns |
| [API: Assets](/docs/api/assets)                                | sprite sheets, bitmap fonts, asset loading |
| [Post-Process Effects](/docs/guides/post-process-effects)             | effect chain, custom effects               |
