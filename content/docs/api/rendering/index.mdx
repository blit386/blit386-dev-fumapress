...
See [Bitmap Fonts Guide](https://github.com/blit386/blit386/blob/main/docs/bitmap-fonts.md) for the `.btfont` format spec and BMFont conversion.
...
See [Post-Process Effects Guide](https://github.com/blit386/blit386/blob/main/docs/post-process-effects.md) for parameter reference, the `Effect` interface, `EffectTier`,
...
| ----------------------------------------------------------- | ------------------------------------------ |
| [API: Core](/docs/api/core)                                    | bootstrap, init, camera, core types        |
| [API: Palette](/docs/api/palette)                              | palette setup, presets, effects            |
| [Palette Guide](https://github.com/blit386/blit386/blob/main/docs/palette-guide.md)                           | palette-first workflow and offset patterns |
| [API: Assets](/docs/api/assets)                                | sprite sheets, bitmap fonts, asset loading |
| [Post-Process Effects](https://github.com/blit386/blit386/blob/main/docs/post-process-effects.md)             | effect chain, custom effects               |
| [Bitmap Fonts](https://github.com/blit386/blit386/blob/main/docs/bitmap-fonts.md)                             | .btfont format, BMFont conversion          |
| [Testing](https://github.com/blit386/blit386/blob/main/docs/testing.md)                                       | visual regression for rendering            |
| [Performance Best Practices](https://github.com/blit386/blit386/blob/main/docs/performance-best-practices.md) | batching and draw-call performance         |
