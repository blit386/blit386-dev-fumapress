---
# Generated from blit386/docs/bitmap-fonts.md by scripts/sync-docs-from-engine.mjs.
# Do not edit by hand: edit the engine source, then run `pnpm run sync:docs`.
title: "Bitmap Fonts in BLIT386"
...
| ---------------------------------- | --------------------------------------- |
| [API: Assets](/docs/api/assets)       | `BitmapFont` loading and asset limits   |
| [API: Rendering](/docs/api/rendering) | `BT.printFont` and palette offset       |
| [Palette Guide](/docs/guides/palette)  | indexize and `paletteOffset` for glyphs |
| [API: Palette](/docs/api/palette)     | palette addressing for text colors      |
