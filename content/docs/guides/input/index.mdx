---
# Generated from blit386/docs/input.md by scripts/sync-docs-from-engine.mjs.
...
| ----------------------------------------------------- | ----------------------------------------------------- |
| [API: Core](/docs/api/core)                              | `BT.isDown` / `isPressed` / `isKeyDown` and configure |
| [Overlay Guide](https://github.com/blit386/blit386/blob/main/docs/overlay.md)                           | Backquote and bottom-left corner toggle               |
| [Deprecation Timeline](/docs/reference/deprecations)               | renamed input aliases (`buttonDown` -> `isDown`)      |
| [Developer Experience](https://github.com/blit386/blit386/blob/main/docs/developer-experience-guide.md) | boolean naming (hold vs edge)                         |
