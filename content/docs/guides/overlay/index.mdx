---
# Generated from blit386/docs/overlay.md by scripts/sync-docs-from-engine.mjs.
...
Configure-time flags, style objects, and worked examples live in [API: Core — Overlay](/docs/api/core#overlay). This guide
...
px**), palette grid height when enabled, and ~**13 px** footer hint bar. See [API: Core — Overlay](/docs/api/core#overlay)
for layout formulas.
...
[Palette Presets — HUD](/docs/guides/palette-presets#hud-preset-paletteapplyhud).
...
| ------------------------------------------------------ | ------------------------------------------------ |
| [API: Core — Overlay](/docs/api/core#overlay)             | Full configure table, style objects, layout math |
| [API: Assets — System Font](/docs/api/assets#system-font) | `BT.systemPrint` for demo HUD text               |
| [API: Palette](/docs/api/palette)                         | `applyHUD`, preset factories, effects            |
| [Input Guide](/docs/guides/input)                                | Pointer slots for corner toggle                  |
| [Palette Presets](/docs/guides/palette-presets)                  | Exact HUD slot colors                            |
| [Testing](https://github.com/blit386/blit386/blob/main/docs/testing.md)                                  | Overlay integration tests                        |
| [Deprecation Timeline](/docs/reference/deprecations)                | `overlayEnabled` -> `isOverlayEnabled` rename    |
