---
# Generated from blit386/docs/palette-presets.md by scripts/sync-docs-from-engine.mjs.
...
| --------------------------------- | ------------------------------------------------------- |
| [Palette Guide](/docs/guides/palette) | workflow for setup, offsets, effects, and refresh rules |
| [API: Palette](/docs/api/palette)    | runtime palette APIs and effect signatures              |
| [Overlay Guide](/docs/guides/overlay)       | HUD preset and `applyHUD` slot colors                   |
| [API: Assets](/docs/api/assets)      | sprites and fonts that use preset colors                |
