...
| [Testing](/docs/reference/testing)                                       | palette testing patterns and visual regression     |
| [Post-Process Effects](/docs/guides/post-process-effects)             | pixel-tier effects on palette indices              |
| [Performance Best Practices](/docs/performance/best-practices) | palette-offset performance patterns                |
