---
# Generated from blit386/docs/palette-guide.md by scripts/sync-docs-from-engine.mjs.
...
RGBA values. See [Palette addressing](/docs/api/palette#palette-addressing).
...
See [Palette addressing](/docs/api/palette#palette-addressing).
...
For benchmark workflow and CI thresholds, see [Performance Testing](https://github.com/blit386/blit386/blob/main/docs/performance-testing.md).
...
| ----------------------------------------------------------- | -------------------------------------------------- |
| [API: Palette](/docs/api/palette)                              | API reference for palette methods and effect calls |
| [API: Assets](/docs/api/assets)                                | `SpriteSheet.loadIndexed`, fonts, and asset flow   |
| [API: Rendering](/docs/api/rendering)                          | sprite offset semantics and draw APIs              |
| [Palette Presets](/docs/guides/palette-presets)                       | exact built-in palette color data                  |
| [Testing](https://github.com/blit386/blit386/blob/main/docs/testing.md)                                       | palette testing patterns and visual regression     |
| [Post-Process Effects](/docs/guides/post-process-effects)             | pixel-tier effects on palette indices              |
| [Performance Best Practices](https://github.com/blit386/blit386/blob/main/docs/performance-best-practices.md) | palette-offset performance patterns                |
