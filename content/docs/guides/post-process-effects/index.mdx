---
# Generated from blit386/docs/post-process-effects.md by scripts/sync-docs-from-engine.mjs.
...
see [Resolution model](/docs/api/core#resolution-model) in the core API docs.
...
| ------------------------------------------------------------------- | -------------------------------------------------------- |
| [API: Rendering](/docs/api/rendering)                                  | `effectAdd` / `effectRemove` / `effectClear` and presets |
| [API: Core](/docs/api/core#resolution-model)                           | resolution model, requested vs active backend            |
| [API: Palette](/docs/api/palette)                                      | pixel-tier effects run on palette indices                |
| [Testing](https://github.com/blit386/blit386/blob/main/docs/testing.md)                                               | visual regression for the effect chain                   |
| [Software Fallback Smoke Matrix](https://github.com/blit386/blit386/blob/main/docs/software-fallback-smoke-matrix.md) | effects unsupported in the software backend              |
