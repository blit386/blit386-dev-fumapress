...
| [Testing](/docs/reference/testing)                                               | visual regression for the effect chain                   |
| [Software Fallback Smoke Matrix](/docs/performance/smoke-matrix) | effects unsupported in the software backend              |
