...
| --------------------------------------------- | ------------------------------------------ |
| [Performance Testing](/docs/performance/testing) | measure before optimizing (CPU benchmarks) |
| [API: Rendering](/docs/api/rendering)            | batching and draw-call performance         |
| [Palette Guide](/docs/guides/palette)             | palette-offset performance patterns        |
| [Overlay Guide](/docs/guides/overlay)                   | reading the on-screen FPS and timing chart |
