---
# Generated from blit386/docs/software-fallback-smoke-matrix.md by scripts/sync-docs-from-engine.mjs.
...
| ---------------------------------------------------- | ----------------------------------------------- |
| [API: Core](/docs/api/core#requested-vs-active-backend) | requested vs active backend, `BT.activeBackend` |
| [Post-Process Effects](/docs/guides/post-process-effects)      | effects excluded in the software backend        |
| [Testing](/docs/reference/testing)                                | automated visual parity tests                   |
| [Overlay Guide](/docs/guides/overlay)                          | backend name shown on the overlay top bar       |
