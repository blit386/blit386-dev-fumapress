...
| ----------------------------------------------------------- | ---------------------------------------- |
| [Testing](/docs/reference/testing)                                       | unit, integration, and visual test tiers |
| [Performance Best Practices](/docs/performance/best-practices) | when and how to optimize hot paths       |
| [Developer Experience](https://github.com/blit386/blit386/blob/main/docs/developer-experience-guide.md)       | `pnpm run bench` and CI workflow         |
