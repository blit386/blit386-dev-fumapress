---
# Generated from blit386/docs/deprecations.md by scripts/sync-docs-from-engine.mjs.
...
| ----------------------------------------------------- | -------------------------------------------------- |
| [API: Core](/docs/api/core)                              | current `BT` getters and `HardwareSettings` fields |
| [Input Guide](/docs/guides/input)                               | current input API names                            |
| [Overlay Guide](https://github.com/blit386/blit386/blob/main/docs/overlay.md)                           | current overlay configure flags                    |
| [Developer Experience](https://github.com/blit386/blit386/blob/main/docs/developer-experience-guide.md) | boolean naming and migration policy                |
