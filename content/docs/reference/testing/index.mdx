---
# Generated from blit386/docs/testing.md by scripts/sync-docs-from-engine.mjs.
...
See also [CLAUDE.md](https://github.com/blit386/blit386/blob/main/CLAUDE.md) (**Known Testing Quirks**):
...
| ------------------------------------------------------------------- | ------------------------------------------ |
| [API: Palette](/docs/api/palette)                                      | palette APIs and effect signatures         |
| [Palette Guide](/docs/guides/palette)                                   | palette-first workflow and refresh rules   |
| [Palette Presets](/docs/guides/palette-presets)                               | exact built-in preset and HUD color values |
| [API: Assets](/docs/api/assets)                                        | indexed sprite setup and palette offsets   |
| [API: Core](/docs/api/core)                                            | backend, overlay, and bootstrap tests      |
| [Overlay Guide](/docs/guides/overlay)                                         | overlay integration test inventory         |
| [Post-Process Effects](/docs/guides/post-process-effects)                     | visual regression for the effect chain     |
| [Tooling](https://github.com/blit386/blit386/blob/main/docs/tooling.md)                                               | declaration tooling checks                 |
| [Performance Testing](/docs/performance/testing)                       | CPU benchmarks (test tier 4)               |
| [Software Fallback Smoke Matrix](/docs/performance/smoke-matrix) | manual software backend matrix             |
